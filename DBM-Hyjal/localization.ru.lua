...
L:SetMiscLocalization{
	...
	Infernal		= "Инфернала",
	RAGE_YELL_PULL	    = "Началось последнее завоевание Легиона! Скоро весь этот мир покорится нам! Пленных не брать!",
	ANETHERON_YELL_PULL	= "Вы защищаете давно обреченный мир! Бегите сейчас – и получите возможность немного продлить свои жалкие жизни!",
	KAZROGAL_YELL_PULL	= "Молите о пощаде! Вскоре ваше ничтожное существование закончится!",
	AZGALOR_YELL_PULL	= "Началось последнее завоевание Легиона! Скоро весь этот мир покорится нам! Пленных не брать!"
}
