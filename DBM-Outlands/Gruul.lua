...
local timerGroundSlamCD	= mod:NewCDTimer(74, 33525, "Ground Slam CD", nil, nil, 2)--74-80 second variation,and this is just from 2 pulls.
...
local timerSilenceCD	= mod:NewCDTimer(32, 36297, "Silence CD", nil, nil, 5, nil, DBM_CORE_L.HEALER_ICON)--Also showing a HUGE variation of 32-130 seconds.
