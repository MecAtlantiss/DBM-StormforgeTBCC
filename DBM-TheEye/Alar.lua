...
local timerMeteor		= mod:NewCDTimer(52, 35181, "Dive Bomb CD", nil, nil, 2)
local timerArmor		= mod:NewTargetTimer(60, 35410, nil, "Tank", 2, 5, nil, DBM_CORE_L.TANK_ICON)
local timerNextPlatform	= mod:NewTimer(38, "NextPlatform", 40192, nil, nil, 6)--This has no spell trigger, the target scanning bosses target is still required if loop isn't accurate enough.
