...
local timerWhirlwindCD		= mod:NewCDTimer(25, 33238, "Whirlwind CD", nil, nil, 2)
local timerWhirlwind		= mod:NewBuffActiveTimer(15, 33238, nil, nil, nil, 2)
local timerFelhunter		= mod:NewCDTimer(42.5, 33131, nil, nil, nil, 1)--Buff Active or Cd timer?
...
function mod:OnCombatStart(delay)
	timerWhirlwindCD:Start(51-delay)
end
