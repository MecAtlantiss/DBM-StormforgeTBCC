...
local timerRoar		= mod:NewTimer(14.5, "DBM_OZ_WARN_ROAR", "132117", nil, false, 1)
local timerStrawman	= mod:NewTimer(24, "DBM_OZ_WARN_STRAWMAN", "133136", nil, false, 1)
local timerTinhead	= mod:NewTimer(33, "DBM_OZ_WARN_TINHEAD", "133070", nil, false, 1)
local timerTito		= mod:NewTimer(52.5, "DBM_OZ_WARN_TITO", "I132266", nil, false, 1)
