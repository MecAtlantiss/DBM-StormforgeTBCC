...
local timerElemental	= mod:NewTimer(14, "TimerElementalActive", 39088, nil, nil, 1)--Blizz says they are active 20 seconds per patch notes, but my logs don't match those results. 22 second up time.
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif args.spellId == 38509 then
