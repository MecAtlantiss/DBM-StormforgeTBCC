...
local timerTotem		= mod:NewTargetTimer(26, 38236, "Next Spitfire Totem", nil, "Show timer for next Spitfire Totem", 1)

local berserkTimer		= mod:NewBerserkTimer(600)

function mod:OnCombatStart(delay)
	berserkTimer:Start(-delay)
	timerTotem:Start(23-delay)
end
