...
local timerHellfire				= mod:NewCDTimer(14.5, 30859, "New Hellfire begins", nil, "Show timer for when newest infernal's Hellfire begins", 3)
...
function mod:OnCombatStart(delay)
	self:SetStage(1)
	timerNextInfernal:Start(20-delay)--14-21?
...
function mod:CHAT_MSG_MONSTER_YELL(msg)
	if msg == L.DBM_PRINCE_YELL_INF1 or msg == L.DBM_PRINCE_YELL_INF2 then
		...
		timerNextInfernal:Start(self.vb.phase == 3 and 15.6 or 44.7)--44-48
