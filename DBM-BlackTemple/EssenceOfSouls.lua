...
local specWarnShield	= mod:NewSpecialWarningDispel(41431, nil, nil, 2, 1, 2)
local specWarnSpite		= mod:NewSpecialWarningYou(41376, nil, nil, nil, 1, 2)

--Phase 1
local timerPhaseChange	= mod:NewPhaseTimer(44)
local timerFrenzy		= mod:NewBuffActiveTimer(15, 41305, nil, "Tank|Healer", 2, 5, nil, DBM_CORE_L.TANK_ICON)
local timerNextFrenzy	= mod:NewNextTimer(28, 41305, nil, "Tank|Healer", 2, 5, nil, DBM_CORE_L.TANK_ICON)
--Phase 2
...
local timerNextShock	= mod:NewCDTimer(6, 41426, nil, nil, nil, 4, nil, DBM_CORE_L.INTERRUPT_ICON)--Blizz lied, this is a 12-15 second cd. you can NOT solo interrupt these with most classes
local timerNextShield	= mod:NewCDTimer(15, 41431, nil, nil, 2, 5, nil, DBM_CORE_L.MAGIC_ICON)
--Phase 3
...
function mod:OnCombatStart(delay)
	...
	timerNextFrenzy:Start(46-delay)
	warnFrenzySoon:Schedule(41-delay)
end
