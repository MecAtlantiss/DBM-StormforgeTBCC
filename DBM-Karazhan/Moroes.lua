...
local timerVanishCD			= mod:NewCDTimer(22.1, 29448, "Vanish CD", true, nil, 6)--35.1-51.8
local timerGougeCD			= mod:NewCDTimer(22.6, 29425, "Gouge CD", true, nil, 6)--22.6-43.6
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args.spellId == 37023 then
		warningFrenzy:Show()
